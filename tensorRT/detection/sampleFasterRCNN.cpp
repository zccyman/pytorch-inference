...
//const std::string CLASSES[OUTPUT_CLS_SIZE]{ "background", "tail", "longjump"};
...
{
    std::vector<std::string> dirs{"../../../../thirdparty/TensorRT/data/faster-rcnn/", 
		"../../../../thirdparty/TensorRT/data/faster-rcnn/"};
...
int main(int argc, char** argv)
{
    ...
    // available images
    std::vector<std::string> imageList = {"000542.ppm"};
